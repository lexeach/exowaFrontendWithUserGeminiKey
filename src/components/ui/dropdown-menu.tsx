...
>(({ className, side = 'bottom', sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'right-0 w-[224px] absolute',
        'z-50 min-w-[8rem] overflow-hidden rounded-md border border-neutral-200 py-1 bg-white text-neutral-950 shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-[16px] py-[12px] text-sm font-semibold',
      inset && 'pl-8',
      className
    )}
    {...props}
