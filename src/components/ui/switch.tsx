...
>(({ className, dir = false, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        `pointer-events-none block h-4 w-4 rounded-full bg-white shadow-lg ring-0 transition-transform ${dir ? 'data-[state=checked]:-translate-x-4' : 'data-[state=checked]:translate-x-4'} data-[state=unchecked]:translate-x-0 dark:bg-neutral-950`
      )}
    />
  </SwitchPrimitives.Root>
));
